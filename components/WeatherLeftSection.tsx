...
import { WeatherData, SearchBarSliceData, PrismicSlice } from "@/types/weather";
...
export default function WeatherLeftSection({ weatherData, loading }: Props) {
  ...
  return (
    <div className="flex flex-col gap-2 md:gap-4 flex-1">
      ...
      {/* Gradient Box */}
      <div
        className="relative  rounded-xl h-[408px] md:h-[550px] p-8 flex flex-col bg-cover bg-center "
      ...
      >
        ...
        <div className="absolute bottom-4 left-8 text-white font-nunito text-[16px] md:text-[20px] leading-[20px] flex flex-col md:flex-row lg:flex-row gap-1">
          ...
          {/* Status Text (Regular) */}
          <span className="font-normal lg:ml-2">
